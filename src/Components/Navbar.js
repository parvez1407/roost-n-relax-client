  ...
  return (
    <header className='text-gray-900 body-font shadow-sm'>
      <div className=' mx-auto flex flex-wrap py-5 px-20 flex-col md:flex-row items-center'>
        <Link
          to='/'
          className='flex title-font font-medium items-center text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-indigo-500 mb-4 md:mb-0'
        >
          <span className='ml-3 text-2xl font-bold '>RoostNRest</span>
        </Link>
        <nav className='md:ml-auto flex flex-wrap items-center text-base justify-center'>
          {user?.email ? (
            <>
              <div className='relative inline-block '>
                <button
                  ...
                  className='relative z-10 block p-2 text-gray-700 bg-white border border-transparent rounded-md focus:border-indigo-500 focus:ring-opacity-40  focus:ring-purple-300  focus:ring  focus:outline-none'
                >
                  <svg
            ...
            <>
              <Link to='/login' className='mr-5 hover:text-purple-600'>
                Login
              </Link>
