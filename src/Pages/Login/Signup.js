...
const Signup = () => {
  ...
  const handleSubmit = event => {
    ...
    const url = 'https://api.imgbb.com/1/upload?key=baacb734deaddafa6a156277cb2167a5';
          ...
          .then(result => {
            ...
            updateUserProfile(name, imageData.data.display_url)
              .then(() => {
                verifyEmail()
                  .then(() => {
                    toast.success('Please check you email for verification link', { autoClose: 500 })
        ...
        <div className='flex justify-center space-x-4'>
          <button onClick={handleGoogleSignIn} aria-label='Log in with Google' className='p-3 rounded-sm'>
            <svg
              ...
              viewBox='0 0 32 32'
              className='w-5 h-5 fill-current hover:text-indigo-400'
            >
